...
<xsl:stylesheet version="1.0"
        ...
        <html>
            ...
            <body>
                ...
                <div class="cartolina-container">
                    <div id="immagineFacs">
                        <img src="IMG/211R.jpg" id="R211map" usemap="#map211"/>
                        <map name="map211">
                            <xsl:apply-templates select="tei:TEI[@xml:id='c211']//tei:facsimile/tei:surface[@xml:id='retro211']"/>
                        </map>
                    </div>
                    ...
                    <div id="riquadro">
                        ...
                        <div id="testoFacs">
                                    ...
                                    <tr>
                                        <td>
                                            <div id="ruota" class="ruota">  
                                                <xsl:apply-templates select="//tei:text[@xml:id='cartolina211']/tei:body//tei:div[@type='message']"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="idnoFacs">
                                                <xsl:apply-templates select="tei:TEI[@xml:id='c211']//tei:body//tei:div[@type='codice']"/>
                                            </div>
                                            <xsl:apply-templates select="//tei:text[@xml:id='cartolina211']/tei:body//tei:div[@type='destination']//tei:address"/>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div id="timbriCartolina">
                                ...
                                <xsl:apply-templates select="//tei:text[@xml:id='cartolina211']/tei:body//tei:div[@type='destination']//tei:stamp"/>
                            </div>
                ...
                <div id="testoCartolinaTypo">
                    ...
                    <div id="testoStampato">
                        <xsl:apply-templates select="//tei:text[@xml:id='cartolina211']/tei:body//tei:div[@type='typography']"/>
                    </div>
                </div>
            </body> 
        </html>
    ...
    <xsl:template match="tei:surface[@xml:id='retro211']">
